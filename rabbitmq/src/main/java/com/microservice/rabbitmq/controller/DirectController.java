...
public class DirectController {
    ...
    public ResponseEntity<Response> sendMessageWithDirectExchange(@PathVariable int key)
    {
        ...
        return new ResponseEntity<Response>(new Response("Direct Excahnge"), HttpStatus.OK) ;
    }
